...
const translations = {
  en: {
    ...
    btnSync: '<i class="material-icons">cloud_sync</i> Sync to Cloud',
  ...
  de: {
    ...
    btnSync: '<i class="material-icons">cloud_sync</i> In Cloud Sync',
  ...
  nl: {
    ...
    btnSync: '<i class="material-icons">cloud_sync</i> Sync naar Cloud',
  ...
  jp: {
    ...
    btnSync: '<i class="material-icons">cloud_sync</i> クラウド同期',
  ...
  kr: {
    ...
    btnSync: '<i class="material-icons">cloud_sync</i> 클라우드 동기화',
  ...
  sc: {
    ...
    btnSync: '<i class="material-icons">cloud_sync</i> 同步云端',
  ...
  tc: {
    ...
    btnSync: '<i class="material-icons">cloud_sync</i> 同步雲端',
